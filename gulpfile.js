...
gulp.task('jade', function() {
  return gulp.src('app/jadeFiles/index.jade')
    .pipe(jade({
      pretty: true
    }))
    .pipe(gulp.dest('app'))
...
gulp.task('serve', ['stylesheet', 'javascript', 'fonts'], function () {
  ...
  gulp.watch(['app/jadeFiles/_includes/*.jade','app/_jadeFiles/*.jade'], ['jade']);
  gulp.watch(['app/css/sprites/*.sass', 'app/css/**/*.scss', 'app/css/**/*.sass'], ['stylesheet']);
...
gulp.task('build', ['jshint', 'javascript', 'stylesheet', 'html', 'images', 'fonts', 'extras', 'jade'], function () {
